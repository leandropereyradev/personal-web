        ...
        {estado && (
          ...
          >
            <motion.div
              ...
              className="thanks_about"
            >
              <h3 className="thanks_title">¡Sé quien soy, de donde vengo y hacia donde voy!</h3>
              <div className="thanks_info-container">
                <div className="thanks_info_title-container">
                  <h1 className="thanks_info_title_title">Soy Leandro Pereyra, Desarrollador Web</h1>
                  <p className="version">v1.0 - Trainee</p>
                  <p className="thanks_info_title_text">Mi padre me dijo una vez:</p>
                  <div className="thanks-papa">
                    <p className="thanks_info_title_text dialog">
                  ...
                  <p className="thanks_info_title_text">
                ...
                <div className="thanks_skills-container"></div>
                <div className="thanks_exit">
